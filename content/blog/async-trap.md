...
1. **Tolerant Reader.** Код сервиса-потребителя (да и поставщика, для rollback) должен содержать парсеры для нескольких версий контракта. Это плата за независимые релизы и возможность дочитать старые сообщения.
